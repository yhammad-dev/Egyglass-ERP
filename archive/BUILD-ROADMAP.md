> 🔴 **ملف مؤرشف — لا يُستخدم كمصدر (2026-07-25 · TO-17).**
> يحتوي معلومات stack **غير صحيحة**، أبرزها إعلان **Next.js 16** بينما الواقع المُتحقَّق هو
> **Next.js 15.3.4**.
> ⚠️ **انتبه:** ترويسة «تحديث الحقيقة» أدناه **ليست تصحيحًا** — هي نفسها تُرسّخ الخطأ إذ تنص
> على «Next.js 16 (وليس 15)». لا تعتمد عليها.
> **الأثر الواقعي لهذه المعلومة الخاطئة:** أنتجت ملف `src/proxy.ts` (اصطلاح خاص بـNext 16)
> فظل **ميتًا لا يُحمَّل** على 15.x بينما سجّلته مراجعة الأمن كضابط نافذ — حُذف في TO-14
> وصُحِّحت الوثائق في TO-17.
> **المرجع الصحيح للـstack: `CLAUDE.md`. وللقرارات المُلزِمة: `BACKLOG.md`.**
> المتن أدناه محفوظ كما هو للتأريخ فقط.
