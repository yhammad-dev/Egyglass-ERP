...
> **Next.js 15.3.4**.
> **الأثر الواقعي:** هذه المعلومة أنتجت ملف `src/proxy.ts` (اصطلاح خاص بـNext 16) فظل
> **ميتًا لا يُحمَّل** على 15.x بينما سجّلته مراجعة الأمن كضابط نافذ — حُذف في TO-14
