...
| `SALES_REP` | عملاؤه (`ownerId`) **+ مَن يغطّيهم رسميًا فقط** (`coveredById`) — لا قراءة عامة لعملاء الزملاء · كتابة عبر-مندوب مُسجَّلة | التغطية إسناد صريح لا وصول مفتوح · logging كامل (SF-20، 2026-07-25) |
